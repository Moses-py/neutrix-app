          ...
          <div className="flex lg:flex-row flex-col justify-between">
            ...
            <div className="w-full md:w-3/4">
              <ParagraphText>
                ...
                <span className="font-bold text-textLight">Our mission</span> is
                to empower talents through tech education.{" "}
                <span className="font-bold text-textLight">Our vision</span> is
                to build the most convenient education center to connect talents
                and professionals.
              </ParagraphText>
            </div>
          </div>
