      ...
      <div className="wrapper w-full h-full font-secondary p-5">
        <div className="md:container lg:w-[50%]">
          ...
          <div className="info_text my-[2rem]">
            ...
            <p className="my-[2rem]">
              Please ensure to keep your answers stored somewhere in memory and
              this would be required if you want to recover your account.
            </p>
          </div>
          <form onSubmit={handleVerifyUser}>
            ...
            <button
              ...
              className={`text-white bg-${
                buttonState.color
              } hover:bg-gray-900 rounded-lg text-xs px-5 py-2.5 mr-2 my-2 ${
