          ...
          <div className="w-full p-8 lg:w-1/2 relative">
            ...
            <form onSubmit={submitHandler}>
              <div className="mt-4">
                ...
                <input
                  required
                  className="bg-gray-200 text-gray-700 outline-none border border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                  type="email"
              ...
              <div className="mt-4 relative">
                ...
                <div className="absolute inset-y-0 top-[32px] right-3 flex items-center pl-3 z-50">
                  {showPassword ? (
                    <Image
